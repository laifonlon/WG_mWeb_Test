<%@ Page Title="玩股精選文章 - 玩股網手機版" Language="VB" MasterPageFile="~/m_search.master" AutoEventWireup="false" CodeFile="Article.aspx.vb" Inherits="blog" EnableViewState="False" %>
...
<ItemTemplate>
    ...
    <td class="content" style="vertical-align:top; padding-left:5px;">
        ...
        <div class="pvmain"><h3 style="font-size:1.2em;"><a class="Atitle" href='blog.aspx?bid=<%# Eval("BlogID") %>'><asp:Literal ID="lblArticleTitleText" runat="server"/></a></h3>
            <p style="font-size:0.9em; line-height:1em;"><asp:Literal ID="lblText" runat="server"/></p>
        </div></a>
    </td></tr></table></div>
    </td>
</ItemTemplate>
