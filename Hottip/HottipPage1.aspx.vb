...
Partial Class Hottip_HottipPage1
    ...
    Protected Sub lvMyCollect_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvMyCollect.DataBound
        ...
        For Each row As ListViewDataItem In lvMyCollect.Items
            ...
            Dim ltlTotalVolume As Literal = row.FindControl("ltlTotalVolume")
            Dim ltlMean60DistanceRate As Label = row.FindControl("ltlMean60DistanceRate")

            If ltlStockNo.Text = "0000" Then
                ltlTotalVolume.Text &= "(億)"
            End If

            If Val(ltlMean60DistanceRate.Text.Trim("%").Trim("-")) < 5 Then
                ltlMean60DistanceRate.ForeColor = Drawing.Color.Goldenrod
                ltlMean60DistanceRate.ToolTip = "離季線5%以內"
            ElseIf Val(ltlMean60DistanceRate.Text.Trim("%").Trim("-")) > 40 Then
                ltlMean60DistanceRate.ForeColor = Drawing.Color.BlueViolet
                ltlMean60DistanceRate.ToolTip = "離季線40%以上"
            End If
