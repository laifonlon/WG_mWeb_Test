<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/m_search.master" CodeFile="HottipPage1.aspx.vb" Inherits="Hottip_HottipPage1" Title="自選股 即時行情 - WantGoo 玩股網 手機版" EnableViewState="false" %>
        ...
        <div id="wg-mystk" class="mblock">
            <div class="hd-bx2 gdt">
                <div class="hp-colt-bx">
                    ...
                    <asp:DropDownList ID="ddlFunctionList" runat="server" AutoPostBack="true">
                        <asp:ListItem Value="1" Selected="True">即時行情</asp:ListItem>
            ...
            <div class="tb-fm bgline tb-fix-rt">
                        ...
                        <asp:ListView ID="lvMyCollect" runat="server" DataSourceID="sdsCollect" EnableViewState="False">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><%# Eval("Low")%></td>
                                    <td><%# Eval("Last")%></td>
                                    <td><asp:Literal ID="ltlTotalVolume" Text='<%# Format(Eval("TotalVolume")/1000,"#,###,###,##0") %>' runat="server"></asp:Literal></td>
                                    <td><asp:Label ID="ltlMean60DistanceRate" Text='<%# Format(Eval("Mean60DistanceRate"), "0.0%")%>' runat="server"></asp:Label></td>
                                    <td><%# Now.ToString("HH:mm")%></td>
                                </tr>
                            </ItemTemplate>
                            <EmptyDataTemplate>
                ...
                <asp:SqlDataSource ID="sdsCollect" runat="server"
                    ...
                    SelectCommand="HottipCollectPage1 @MemberNo,@Group"
