...
Partial Class blog
    Inherits System.Web.UI.Page
     ...
     Protected Sub lvBlog_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvBlog.DataBound
        ...
        For Each item In listView.Items
            ...
            lblImg.Text = "<img src=""" + imgUrl + """ width=""50px"" height=""50px"" />"
            ...
            Dim content As String = "<a href=""" + "blog.aspx?bid=" + lblBlogId.Text + """ class=""pvtext"" style=""color:black;font-size:1em; line-height:1.2em;padding-top:5px;"">"
            ...
            If CBool(lblIsSell.Text) = True OrElse outlinetext.Length > 0 Then
                ...
                content += Strings.Left(newText, 50).Replace("...", "")
            Else
    ...
    Private Sub GetData(ByVal blogid As String, ByRef articletext As String, ByRef outlinetext As String)
        Dim key1 As String = "m_PostView_articletext_" + blogid
        ...
        Dim key2 As String = "m_PostView_outlinetext_" + blogid
