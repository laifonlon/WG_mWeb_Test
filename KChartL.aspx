<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KChartL.aspx.vb" Inherits="KChartL" %>
        ...
        tooltip: {  
            ...
            formatter: function() {
                ...
                s += '</td><td class="name">開</td><td class="val">' +  open +
                        ...
                        '</td></tr><tr><td class="name">' + volume + '</td><td class="val">' + tValue +
...
<div class="mg5" style=" text-align:left; margin:-6px 0px 0px -6px"><div style="background-color:#fff;"><div class="ct">
