...
Partial Class globals2
    ...
    Protected Sub tab_1_Click(sender As Object, e As System.EventArgs) Handles tab_1.Click
        Response.Redirect("globals.aspx")
    End Sub

    Protected Sub tab_2_Click(sender As Object, e As System.EventArgs) Handles tab_2.Click
        Response.Redirect("globals.aspx?g=a")
    End Sub
 
    Protected Sub tab_3_Click(sender As Object, e As System.EventArgs) Handles tab_3.Click
        Response.Redirect("globals.aspx?g=f")
    End Sub

    Protected Sub tab_4_Click(sender As Object, e As System.EventArgs) Handles tab_4.Click
        Response.Redirect("globals.aspx?g=o")
    End Sub

    Protected Sub tab_5_Click(sender As Object, e As System.EventArgs) Handles tab_5.Click
