                ...
                Select Case Request("no").Replace("$", "&").Trim
                    ...
                    Case Else
                        ...
                        If cStockNo.IndexOf("&") <= 0 Then
                            lblTechChat.Text = "<a href=""kchart.aspx?no=" + cStockNo + """><img width=""300px"" src=""" + "http://img.wantgoo.com/stock/Image/" + cStockNo + "sdk.png" + """></a>"
                        Else
                            lblTechChat.Text = "<a href=""kchart.aspx?no=" + cStockNo + """><img width=""300px"" src=""" + "http://www.wantgoo.com/stock/Image/" + cStockNo + "sdk.png" + """></a>"
                        End If
