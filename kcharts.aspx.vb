...
Partial Class kcharts
    ...
    Private Sub LoadData()
        ...
        a.Text = _
        "<table width=""478px"" class=""charttable"" cellpadding=""0"" cellspacing=""0""><tr><td  colspan=""2"">" + Format(Application(stockNo + "_Time"), "MM/dd") + "</td>" + _
        "</td><td class=""name"">開</td><td class=""val"">" + Me.GetPrice(Application(stockNo + "_Open")) + _
        ...
        "</td></tr><tr><td class=""name"">" + tVolume + "</td><td width=""10px"">" + tValue + _
       "</td>" + Me.GetMean(stockNo.Trim) + _
        "</td></tr></table>"
    End Sub
    ...
    Private Function GetMean(ByVal stockNo As String) As String
        ...
        If IsNumeric(stockNo) = True Then '台股
            ...
            mean = _
        "<td class=""name"">5日</td><td>" + Me.GetPrice(Application(stockNo + "_Mean5")) + _
        "</td><td class=""name"">10日</td><td>" + Me.GetPrice(Application(stockNo + "_Mean10")) + _
        "</td><td class=""name"">20日</td><td>" + Me.GetPrice(Application(stockNo + "_Mean20")) + _
        "</td><td class=""name"">60日</td><td>" + Me.GetPrice(Application(stockNo + "_Mean60"))
        Else
        ...
        "</td><td class=""name"">10日</td><td>" + Me.GetPrice(CSng(lastMean10(lastMean10.Length - 1).Trim)) + _
    ...
    Public Function GetData(ByVal type As String) As String
        ...
        If Request("m") Is Nothing AndAlso Request("h") IsNot Nothing Then
            If Application(stockNo + "_Tech0.41Y_LastTime") Is Nothing OrElse Now > Application(stockNo + "_Tech0.41Y_LastTime") Then
                'StockLoader.Instance.LoadTech1Y(stockNo)
                StockLoader.Instance.LoadTechDaily(stockNo, 0.41)
            End If

            Dim time As String = "_0.41Y"
