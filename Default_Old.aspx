<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/m_search.master" CodeFile="Default_Old.aspx.vb" Inherits="_Default_Old" Title="WantGoo 玩股網 手機版" EnableViewState="False" %>
...
<uc9:Mob_320x50 ID="Mob_320x501" runat="server" /></div>
...
<%--廣告--%><uc10:Mob_300x250 ID="Mob_300x2501" runat="server" />
</div>
