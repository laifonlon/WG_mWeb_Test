...
<%@ OutputCache Duration="60" VaryByParam="bid" %>
<%@ Register src="AD/Mob_320x50.ascx" tagname="Mob_320x50" tagprefix="uc1" %>
<%@ Register src="AD/Mob_300x250.ascx" tagname="Mob_300x250" tagprefix="uc2" %>
...
<ItemTemplate>
<div id="bgtitle">
    <h3><asp:Literal ID="lArticleTitle" runat="server" Text='<%# Eval("ArticleTitle")%>'></asp:Literal></h3>
    <h5><span><%# Eval("NickName")%></span> 於 <%# Eval("PublishTime")%> 發布</h5>
    <p><%--<%# Eval("RecommendCount")%> 回應 | --%><%# Eval("ViewCount")%> 瀏覽 | <%--<asp:Label ID="lblCollectCount" runat="server"></asp:Label> 收藏 | --%><%# Eval("Good")%> 推薦 | <%--<asp:Label ID="lblFoucsCount" runat="server"></asp:Label>追蹤</p>--%>
</div>
<div id="bgcont">
<div style="margin-left: -5px">
<uc1:Mob_320x50 ID="Mob_320x501" runat="server" />
</div>
<asp:Label ID="lArticleText" runat="server" Text='<%# Server.HtmlDecode(Eval("ArticleText")) %>'></asp:Label>
<br />
<div style="margin-bottom:5px; margin-top:-20px;font-weight: bold;"><asp:HyperLink ID="hlEMailSubscribe" runat="server"  ForeColor="#BD4253" Font-Size="1em" Target="_blank"></asp:HyperLink></div>
...
<asp:Label ID="lArticleID" runat="server" Text='<%# Eval("ArticleID")%>' Visible="False"></asp:Label>
    ...
    <div id="bgshare">
        ...
        <tr><td style="text-align:left;"><asp:Literal ID="lbllike1" runat="server" Text=""></asp:Literal></td>
                <td style="text-align:left;">&nbsp;&nbsp;<div style="display: inline-block;"><asp:Literal ID="lblLine" runat="server" Text=""></asp:Literal></div></td>
                 <td style="text-align:left;">&nbsp;&nbsp;<asp:Literal ID="lblGPlus" runat="server" Text=""></asp:Literal></td></tr></table>
    </div>
<uc1:Mob_320x50 ID="Mob_320x502" runat="server" />
<div id="bghot">
...
<%--廣告--%><uc2:Mob_300x250 ID="Mob_300x2501" runat="server" /></div>
