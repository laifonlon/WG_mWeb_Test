...
<asp:GridView ID="gvCollect" runat="server" autogeneratecolumns="False" BorderWidth="0px" datasourceid="sdsCollect" Width="100%" GridLines="None" CellPadding="0" EmptyDataText="無同類個股資料" Font-Size="1.5em" RowStyle-Height="1.2em">
    <RowStyle CssClass="gvtable_row" Font-Size="1em" ></RowStyle>
    <columns>
...
<asp:GridView ID="gvRelate" runat="server" autogeneratecolumns="False" BorderWidth="0px" datasourceid="sdsRelate" Width="100%" GridLines="None" CellPadding="0" EmptyDataText="無相關個股資料" Font-Size="1.4em">
