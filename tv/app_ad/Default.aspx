<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/m_search.master" CodeFile="Default.aspx.vb" Inherits="_Default" Title="WantGoo 玩股網 手機版" EnableViewState="False" %>
...
<div id="gs">
<table cellpadding="0" cellspacing="0"><tr><td style="width:49%; padding-right:5px;vertical-align:top;">
<div style="background-color:#fff; margin-top:5px;">
<div class="hd1"><h3>頭版頭條 <span>HEADLINE</span></h3></div>
<div class="ct">
<div id="jslidernews3" class="lof-slidecontent outline" style="height:200px;">
<div class="preload"><div></div></div>
    <div  class="button-previous"></div>
    <div  class="button-next"></div>
    <!-- MAIN CONTENT --> 
    <div class="main-slider-content" style="height:200px;">
...
</td><td style="vertical-align:top;width:49%;">
<div class="mg5"><uc2:DealInfo ID="deal1" runat="server" Visible="True" EnableViewState="False" Head="即時指數 <span>INDEX</span>" /></div>
<%--<div class="mg5">
