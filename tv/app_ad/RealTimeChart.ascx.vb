...
Partial Class RealTimeChart
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Dim txt As String = ""
        Dim imageUrl As String = TwStockAccessor.Instance.GetRealTimeChart(stockno, 350, 130)
        'Literal1.Text = txt
        Try
            ...
            lblImg.Text = "<a href=""/chart.aspx?no=" & stockno & "" + """><img src=""" + imageUrl + """ width=""300px""></a>"
