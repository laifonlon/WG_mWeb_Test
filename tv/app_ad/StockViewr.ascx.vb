...
Partial Class StockViewr
    ...
    "    t -= 1;" + _
    "    if (t > 0) {" + _
    "        document.getElementById(""@Control"").innerHTML = t +"" 秒 點我更新"";" + _
    ...
    "          location.reload(); }" + _
    "       else {" + _
    "        document.getElementById(""@Control"").innerHTML = ""1 秒 點我更新"";" + _
    "         setTimeout(""showTime_@ID()"", 1000); }" + _
    "     }" + _
    "}"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Val(lblUpdateInterval.Text) = 0 OrElse Title = "" OrElse Not ShowUpdate Then
            lblElapseTime.Text = ""
        Else
            lblElapseTime.Text = lblUpdateInterval.Text + " 秒 點我更新"
  ...
  "<li><a href=""index.aspx?no=@StockNo""><span class=""in ww30"">@Name</span><span class=""ix ww25"">@Price</span><span class=""up ww25"" style=""color:@ChangeColor;"">@Change</span><span class=""ut ww20"" style=""color:@PercentColor;"">@Percent</span></a></li>"
