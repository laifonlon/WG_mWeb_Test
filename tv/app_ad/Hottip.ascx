...
<div class="mg5">
    <div class="hd1">
        <ul class="tab_tip">
            <li><a href="javascript:tabSwitch(1, 2, 'tabb_', 'content_');" id="tabb_1" class="active">多方選股</a></li>
            <li><a href="javascript:tabSwitch(2, 2, 'tabb_', 'content_');" id="tabb_2">空方選股</a></li>
        </ul>   
